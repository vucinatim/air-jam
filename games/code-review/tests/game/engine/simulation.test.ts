...
import { PUNCH_DURATION_MS } from "../../../src/game/domain/combat-rules";
import {
  BOT_PUNCH_DISTANCE,
  MAX_HP,
  PLAYER_SIZE,
...
} from "../../../src/game/engine/runtime-state";
import { stepMatchFrame } from "../../../src/game/engine/simulation";
import type { SlotParticipant } from "../../../src/game/engine/types";
