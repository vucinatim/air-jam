...
CREATE TABLE "realtime_host_grant_consumptions" (
	...
	CONSTRAINT "realtime_host_grant_consumptions_required_text_check" CHECK (length(btrim("realtime_host_grant_consumptions"."jti")) > 0 and length(btrim("realtime_host_grant_consumptions"."app_id")) > 0),
