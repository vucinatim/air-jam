...
export const HowItWorksDiagram = () => {
  return (
    <div
      ...
      data-figure-description="How Air Jam works overview: 1) Your game mounts a host runtime boundary and displays a QR code with room ID. 2) Players scan the QR on their phones with no app download required. 3) Phone becomes a game controller with joystick and buttons. 4) All input is routed through the Air Jam Server to your game in real time."
    >
      <svg
        viewBox="0 0 700 450"
