...
```
┌──────────────────┐                    ┌──────────────────┐
│   Your Game      │◀──── WebSocket ───▶│  Air Jam Server  │
│   (Host)         │                    │                  │
│                  │                    │   Room: ABCD     │
│  useAirJamHost() │                    │                  │
└──────────────────┘                    └──────────────────┘
...
| Focus | Input Recipient | Use Case |
|-------|-----------------|----------|
| `SYSTEM` | Master Host (Arcade) | Browsing games, navigation |
| `GAME` | Child Host (Your Game) | Active gameplay |
