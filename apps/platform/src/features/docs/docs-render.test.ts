...
const docsCorpusRenderTimeoutMs = 60_000;

describe("docs render validation", () => {
  it(
    "renders every canonical docs page to HTML",
    async () => {
    ...
    docsCorpusRenderTimeoutMs,
  );

  it(
    "preserves server-rendered code blocks for docs pages with fenced code",
    async () => {
      for (const document of getDocsDocuments()) {
