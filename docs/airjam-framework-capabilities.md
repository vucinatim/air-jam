# Air Jam Framework Capabilities
...
This document lists the capabilities Air Jam currently exposes as a framework,
platform, and agent-development system.

It is intentionally a capability inventory, not a plan. Use it to understand
what the system can do today, where each capability lives, and which surface is
the cleanest entrypoint.
...
1. `docs/systems/arcade-surface-contract.md`
...
5. `docs/systems/documentation-architecture.md`
...
4. `docs/systems/analytics-architecture.md`
