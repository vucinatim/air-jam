...
1. [Prerelease Agent Dev Loop Hardening Plan](./2026-05-02-prerelease-agent-dev-loop-hardening-plan.md)
2. [Agent Control System Rewrite Plan](./2026-05-02-agent-control-system-rewrite-plan.md)
3. [Air Jam MCP And Agent Devtools Plan](./2026-05-02-air-jam-mcp-and-agent-devtools-plan.md)
4. [SDK Game Authoring Ergonomics Plan](./2026-04-19-sdk-game-authoring-ergonomics-plan.md)
...
5. archive or rewrite `docs/archive/2026-05-02-harness-visual-contract.md`
