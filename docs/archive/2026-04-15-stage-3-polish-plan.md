...
Archive reason: the shared-shell pass and the per-game polish sweep are landed for the launch set, captures are green again, and the plan's own rule says to stop Stage 3 and hand off to the final manual proof if no new high-signal issue appears. Any remaining polish-shaped item now surfaces as a finding inside [Final Release Checks Plan](./2026-04-19-final-release-checks-plan.md) and loops back into [Final Prerelease Hardening And Cleanup Plan](./2026-04-18-final-prerelease-hardening-and-cleanup-plan.md) if it turns out to matter for launch.
...
4. [Visual Review Harness Plan (Archived)](./2026-04-09-visual-review-harness-plan.md)
