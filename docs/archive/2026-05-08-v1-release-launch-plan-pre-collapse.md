...
7. [Prerelease Systems Closeout Plan (Archived)](../archive/2026-04-09-prerelease-systems-closeout-plan.md)
8. [Controller Preview Dock Plan (Archived)](../archive/2026-04-09-controller-preview-dock-plan.md)
9. [Agent Runtime Contract Plan (Archived)](../archive/2026-04-09-agent-runtime-contract-plan.md)
10. [Stage 3 Polish Plan (Archived)](../archive/2026-04-15-stage-3-polish-plan.md)
11. [Final Prerelease Hardening And Cleanup Plan](./2026-04-18-final-prerelease-hardening-and-cleanup-plan.md)
12. [Final Release Checks Plan](./2026-04-19-final-release-checks-plan.md)
13. [Controller Reconnect And Resume Plan](../archive/2026-04-07-controller-reconnect-resume-plan.md)
14. [Postgres Dev And Analytics Test DB Plan](../archive/2026-04-04-postgres-dev-and-analytics-test-db-plan.md)
15. [Controller Capability And Perf Hardening Plan](../archive/2026-04-04-controller-capability-and-perf-hardening-plan.md)
...
7. run the last prerelease overpass and manual proof pass in [Final Release Checks Plan](./2026-04-19-final-release-checks-plan.md)
...
1. remaining implementation work currently means:
   ...
   2. the only active late implementation/improvement track is [Final Prerelease Hardening And Cleanup Plan](./2026-04-18-final-prerelease-hardening-and-cleanup-plan.md)
...
2. the only active late pass is the bounded [Final Prerelease Hardening And Cleanup Plan](./2026-04-18-final-prerelease-hardening-and-cleanup-plan.md)
...
The Stage 3 launch-set polish pass is complete. Details are archived in [Stage 3 Polish Plan (Archived)](../archive/2026-04-15-stage-3-polish-plan.md).

Any surviving polish-shaped item now surfaces as a finding inside [Final Release Checks Plan](./2026-04-19-final-release-checks-plan.md) and loops back into [Final Prerelease Hardening And Cleanup Plan](./2026-04-18-final-prerelease-hardening-and-cleanup-plan.md) only if it turns out to matter for launch.
...
1. execute [Final Release Checks Plan](./2026-04-19-final-release-checks-plan.md)
...
1. [Final Release Checks Plan](./2026-04-19-final-release-checks-plan.md)
...
All prerelease and release checks live in [Final Release Checks Plan](./2026-04-19-final-release-checks-plan.md). That plan is the single runbook for local launch-set proof, dashboard hosted-release + managed-media proof, official-server proof, playtest reruns, the SDK export audit, the canonical release gate rerun, live deploy validation, and the final go / no-go record.
...
1. done baseline: the controller reconnect/resume contract is now product-proven so a dropped player can rejoin safely during live gameplay without corrupting host state
   ...
   4. implementation details live in [Controller Reconnect And Resume Plan](../archive/2026-04-07-controller-reconnect-resume-plan.md)
2. done baseline: isolate destructive runtime analytics tests onto a dedicated Postgres path and add a repo-owned local development Postgres workflow
   ...
   3. implementation details live in [Postgres Dev And Analytics Test DB Plan](../archive/2026-04-04-postgres-dev-and-analytics-test-db-plan.md)
3. gate privileged controller channels behind an explicit controller capability instead of only room membership
   ...
   3. implementation details live in [Controller Capability And Perf Hardening Plan](../archive/2026-04-04-controller-capability-and-perf-hardening-plan.md)
4. turn the existing server perf sanity harness into a real release-confidence gate
   ...
   4. implementation details live in [Controller Capability And Perf Hardening Plan](../archive/2026-04-04-controller-capability-and-perf-hardening-plan.md)
...
6. improve `air-capture`'s high-priority gameplay clarity and correctness:
   ...
   2. remaining playtest reruns live in [Final Release Checks Plan](./2026-04-19-final-release-checks-plan.md) Workstream D
...
Dashboard hosted-release and managed-media proof lives in [Final Release Checks Plan](./2026-04-19-final-release-checks-plan.md) Workstream B.
...
Official hosting and official-server proof lives in [Final Release Checks Plan](./2026-04-19-final-release-checks-plan.md) Workstream C.
...
Post-deploy live validation lives in [Final Release Checks Plan](./2026-04-19-final-release-checks-plan.md) Workstream G.
