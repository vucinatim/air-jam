...
`ArcadeSurfaceState.orientation` remains a **launch-time hint** (catalog, replication, host UX). See [Arcade Surface Contract](./arcade-surface-system.md) § `orientation`.
...
- Contract: [arcade-surface-system.md](./arcade-surface-system.md)
- Overlay UX history: [archive/2026-03-23-arcade-controller-overlay-plan.md](../archive/2026-03-23-arcade-controller-overlay-plan.md)
