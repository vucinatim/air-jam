...
Archive reason: the broad original extraction plan was superseded by the narrower [Prerelease Systems Closeout Plan](./2026-04-09-prerelease-systems-closeout-plan.md)
...
4. [SDK Surface Plan (Archived)](../archive/2026-03-25-sdk-surface-plan.md)
5. [SDK Composability Plan (Archived)](../archive/2026-03-31-sdk-composability-plan.md)
6. [Showcase Games Release Readiness Plan](./2026-04-09-showcase-games-release-readiness-plan.md)
...
1. showcase-game lifecycle normalization (including explicit ended/game-over phase and basic score/result screens) is tracked in [Showcase Games Release Readiness Plan](./2026-04-09-showcase-games-release-readiness-plan.md), not this SDK extraction track.
