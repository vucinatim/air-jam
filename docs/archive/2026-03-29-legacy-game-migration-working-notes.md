...
1. [V1 Closeout Plan (Archived)](../archive/2026-03-31-v1-closeout-plan.md)
2. [Framework Paradigm](../framework-paradigm.md)
3. [Monorepo Operating System](../monorepo-operating-system.md)
4. [Documentation Architecture](./2026-03-27-documentation-system.md)
5. [Legacy Game Migration Guide](../guides/legacy-game-migration-guide.md)
...
That guide now lives in [Legacy Game Migration Guide](../guides/legacy-game-migration-guide.md).
