...
Ongoing launch-quality work for those games now lives in [Showcase Games Release Readiness Plan](./2026-04-09-showcase-games-release-readiness-plan.md).

Related docs:

1. [Work Ledger](../work-ledger.md)
2. [Game Source Scaffolding Plan](./2026-04-07-game-source-scaffolding-plan.md)
3. [Legacy Game Migration Guide](../guides/legacy-game-migration-guide.md)
