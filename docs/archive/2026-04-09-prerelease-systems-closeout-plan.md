...
3. [Final Prerelease Manual Check Plan](../plans/v1-release-plan.md)
4. [Controller Preview Dock Plan (Archived)](./2026-04-09-controller-preview-dock-plan.md)
5. [Suggestions](../suggestions.md)
6. [SDK Extraction Clean-Swap Plan (Archived)](./2026-04-09-sdk-extraction-clean-swap-plan.md)
7. [Visual Review Harness Plan (Archived)](./2026-04-09-visual-review-harness-plan.md)
8. [Composition Shell Contract Plan (Archived)](./2026-04-09-composition-shell-contract-plan.md)
