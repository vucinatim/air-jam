...
1. [V1 Closeout Plan](./2026-03-31-v1-closeout-plan.md)
2. [Release Prep Plan](./2026-03-31-release-prep-plan.md)
3. [Framework Paradigm](../framework-paradigm.md)
4. [Monorepo Operating System](../monorepo-operating-system.md)
5. [Air Capture Reference Refactor Plan](./2026-03-31-air-capture-reference-refactor-plan.md)
...
1. release-critical infrastructure work, move it into [Release Prep Plan](./2026-03-31-release-prep-plan.md)
2. migration proof work, move it into [V1 Closeout Plan](./2026-03-31-v1-closeout-plan.md)
