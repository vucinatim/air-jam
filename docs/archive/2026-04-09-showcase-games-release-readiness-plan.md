...
Archive reason: the implementation pass is complete enough to archive; final manual proof moved to [Final Prerelease Manual Check Plan](../plans/v1-release-plan.md)

Related docs:

1. [Work Ledger](../work-ledger.md)
2. [V1 Release Launch Plan](../plans/v1-release-plan.md)
3. [Showcase Games Release Readiness Checklist (Archived)](./2026-04-09-showcase-games-release-readiness-checklist.md)
4. [ZeroDays Game Import And Template Promotion Plan](../archive/2026-04-07-zerodays-game-import-template-promotion-plan.md)
5. [Framework Paradigm](../framework-paradigm.md)
6. [Legacy Game Migration Guide](../guides/legacy-game-migration-guide.md)
7. [Environment Contracts](../contracts/environment-contracts.md)
