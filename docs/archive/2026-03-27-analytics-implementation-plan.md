...
1. [Analytics Architecture](../../architecture/analytics-architecture.md)
...
4. [Arcade Architecture Reset Summary](./2026-03-25-arcade-architecture-reset-summary.md)
5. [AI Studio Architecture](.././2026-03-26-ai-studio-system.md)
...
2. keep the long-term architecture in `docs/architecture/analytics-architecture.md`
