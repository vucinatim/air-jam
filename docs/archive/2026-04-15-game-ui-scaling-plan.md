...
Archive reason: the chosen full-bleed fluid scaling model is implemented. `SurfaceViewport` uses full-bleed surface semantics and publishes `--airjam-ui-scale` into Tailwind's theme variables, and the launch set plus scaffold sources consume that shared model. Any residual styling fallout belongs inside [Final Prerelease Hardening And Cleanup Plan](./2026-04-18-final-prerelease-hardening-and-cleanup-plan.md).

Related docs:

1. [Work Ledger](../work-ledger.md)
2. [Stage 3 Polish Plan (Archived)](./2026-04-15-stage-3-polish-plan.md)
3. [Framework Paradigm](../framework-paradigm.md)
4. [Platform Controller Presentation](./2026-05-08-platform-controller-presentation-system.md)
5. [Controller Preview Workspace Plan (Archived)](./2026-04-14-controller-preview-workspace-plan.md)
