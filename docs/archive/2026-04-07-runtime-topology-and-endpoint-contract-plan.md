...
Current release execution now lives in [Work Ledger](../work-ledger.md) and [V1 Release Launch Plan](../plans/v1-release-plan.md).
...
4. [Local Runtime Workflow Modes Plan](./2026-04-07-local-runtime-workflow-modes-plan.md)
5. [Arcade Surface Contract](../contracts/arcade-surface-contract.md)
