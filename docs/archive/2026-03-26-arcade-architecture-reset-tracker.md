...
Reference spec: [Arcade Surface Contract](../../contracts/arcade-surface-contract.md)
...
The concrete target contract now exists in [Arcade Surface Contract](../../contracts/arcade-surface-contract.md).
