...
This document is kept only for maintainers working on the internal visual harness subsystem while [Visual Harness Isolation Plan](./2026-05-02-visual-harness-isolation-plan.md) records the prerelease decision to ghost it from the public framework story.
