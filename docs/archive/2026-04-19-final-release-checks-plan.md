...
3. [Final Prerelease Hardening And Cleanup Plan](./2026-04-18-final-prerelease-hardening-and-cleanup-plan.md)
...
Any export that fails the third part is dropped or deferred. Drop or defer decisions are implementation follow-ups that belong in [Final Prerelease Hardening And Cleanup Plan](./2026-04-18-final-prerelease-hardening-and-cleanup-plan.md) Workstream 5, not here.
