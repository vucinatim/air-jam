...
4. Three near-duplicate state-access hooks (`useAirJamHostState`, `useHostSession`, `useHostRuntimeStateBridge`). Verify against the ledger, then dedupe whatever remains.
