...
This is the single source of truth for the visual bridge.
...
Harness visual behavior is game-local authoring and review logic, not topology or deployment configuration.
