...
Companion to [blog-article-draft.md](./blog-article-draft.md) (the game jam + framework intro post). This one is the **origin / vision** post that comes _first_ — the personal arc and the thesis. The jam post follows ~1–2 weeks later as the "receipts."
