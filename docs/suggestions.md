...
10. Productize the unified dev log sink for scaffolded projects by exposing a published `air-jam-server logs` command and teaching the direct `pnpm exec air-jam-server logs` workflow clearly in the AI pack.
