...
<Callout variant="info" title="Tip">
  If you are using an LLM to help with the migration, copy this guide into the conversation first. Codex or Claude are the best fit for this kind of repo-wide migration work.
</Callout>
