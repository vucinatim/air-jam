...
export function HostView() {
  ...
  const canStartMatch =
    matchPhase === "lobby" && allReady && host.connectionStatus === "connected";
                          ...
                          >
                            <div className="flex items-center justify-between gap-3">
                              ...
                              <span className="font-semibold">
                                {(readyByPlayerId[player.id] ?? false)
                                  ? "Ready"
                                  : "Not ready"}
                              </span>
                            </div>
            ...
            <div className="absolute inset-0 z-20 flex items-center justify-center bg-[#1f2937]/70 p-4">
              <div className="w-full max-w-2xl border border-[#fef3c7] bg-[#fef3c7] p-6 text-[#5c4a2e] shadow-2xl">
                ...
                <button
                  ...
                  className="mt-4 w-full bg-[#8b6914] px-4 py-3 text-lg font-bold tracking-wide text-[#fdf6e3] uppercase transition hover:bg-[#7a5b11]"
                >
                  Back To Lobby
                </button>
              </div>
