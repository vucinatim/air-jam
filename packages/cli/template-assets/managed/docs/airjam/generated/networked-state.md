...
<!-- Canonical public doc: https://airjam.io/docs/sdk/networked-state -->
...
It assumes your app has already mounted `airjam.Controller`.
...
It assumes your app has already mounted `airjam.Host`.
