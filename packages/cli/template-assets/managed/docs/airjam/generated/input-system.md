...
<!-- Canonical public doc: https://airjam.io/docs/sdk/input-system -->
...
It assumes your app has already mounted `airjam.Host` above this view.
...
It assumes your app has already mounted `airjam.Controller` above this view.
