...
phones**. A computer or TV acts as the host display, smartphones become the
controllers, and both humans and coding agents build against the same runtime,
input, state, and release model.
