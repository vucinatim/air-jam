...
This local docs pack is the first place to look during implementation.

It combines:

1. generated canonical docs exported from `content/docs`
2. small local supplements for template-specific operating guidance

For broader public framework docs, use the hosted docs site after checking these local files first.

## Generated Canonical Docs

1. [For Agents](./generated/for-agents.md)
2. [Project Structure](./generated/project-structure.md)
3. [Controller UI](./generated/controller-ui.md)
4. [State And Rendering](./generated/state-and-rendering.md)
5. [Introduction](./generated/introduction.md)
6. [Quick Start](./generated/quick-start.md)
7. [Architecture](./generated/architecture.md)
8. [Host System](./generated/host-system.md)
9. [SDK Hooks](./generated/sdk-hooks.md)
10. [Input System](./generated/input-system.md)
11. [Networked State](./generated/networked-state.md)
12. [Debugging And Logs](./generated/debugging-and-logs.md)
13. [Unified Dev Logs](./generated/unified-dev-logs.md)
...
1. if you are an agent starting a real task, read `docs/airjam/agent-gold-path.md` first
