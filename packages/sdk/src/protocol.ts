...
export type ControllerInputPayload = z.infer<typeof controllerInputSchema>['input']
...
export interface ClientToServerEvents {
  'host:register': (payload: z.infer<typeof hostRegistrationSchema>, callback: (ack: HostRegistrationAck) => void) => void
  'host:state': (payload: z.infer<typeof controllerStateSchema>) => void
  'controller:join': (payload: z.infer<typeof controllerJoinSchema>, callback: (ack: ControllerJoinAck) => void) => void
